...
namespace FlyingDutchmanAirlines_Tests.Views
{
    ...
    public class FlightViewTests
    {
        ...
        public void Constructor_FlightView_Success()
        {
            ...
            FlightView view = new FlightView(flightNumber, (originCity, originCityCode),
        ...
        public void Constructor_FlightView_Success_FlightNumber_Null()
        {
            ...
            FlightView view =
                new FlightView(null, (originCity, originCityCode), (destinationCity, destinationCityCode));
        ...
        {
            string destinationCity = "Ushuais";
